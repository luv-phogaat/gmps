"""
Django settings for gmps_python project.
...
SECRET_KEY = '4m#k)c!_ua7&%=r^sh+8crse$w%1)t4z1*bob&80-0s^d08d%3'
...
WSGI_APPLICATION = 'gmps_python.wsgi.application'
